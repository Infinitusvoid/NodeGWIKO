...
void main()
{
    ...
    imageStore(out2, pixel_coords, color);
    imageStore(out3, pixel_coords, color);
}
"""
    ...
    def test(self, int_image_width, int_image_height, int_frame, int_local_size_x, int_local_size_y, print_to_screen, string_glsl_source):
