...
void main()
{
 ...
 color.g = 0.5 + 0.2 * sin(color.r * 100.0);
 vec4 color_image_0 = imageLoad(input0, pixel_coords);
 vec4 color_image_1 = imageLoad(input1, pixel_coords);
 vec4 color_image_2 = imageLoad(input2, pixel_coords);
 vec4 color_image_3 = imageLoad(input3, pixel_coords);
 // imageStore(out0, pixel_coords, color);
 // imageStore(out1, pixel_coords, color_image_0);
 // imageStore(out2, pixel_coords, color_image_1);
 // imageStore(out3, pixel_coords, color_image_2);
 imageStore(out0, pixel_coords, color_image_0);
 imageStore(out1, pixel_coords, color_image_1);
 imageStore(out2, pixel_coords, color_image_2);
 imageStore(out3, pixel_coords, color_image_3);
}
