...
void main()
{
    ...
    imageStore(out0, pixel_coords, color_image_0 + color);
}
"""
    ...
    def test(self, input0, int_image_width, int_image_height, int_frame, int_local_size_x, int_local_size_y, print_to_screen, string_glsl_source):
